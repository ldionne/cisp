...
#define new_type CISP_DEFCLASS((setf b new b) (setf c new c) (setf d new d))


[[[
CISP_BATCH_SETF(type, new_type) == new_type
CISP_BATCH_SETF(type, CISP_DEFCLASS((setf e e) (setf b new b))) == CISP_DEFCLASS((setf b new b) (setf c c) (setf d ~ ~ ~) (setf e e))
CISP_BATCH_SETF(type, CISP_I_EMPTY_TYPE()) == type
CISP_BATCH_SETF(CISP_I_EMPTY_TYPE(), type) == type

CISP_DEFCLASS((batch_setf type)) == type
]]]
