...
[[[
CISP_DEFCLASS((setf token value)) == ((t o k e n, value))
CISP_DEFCLASS((setf token ~ ~ ~)) == ((t o k e n, ~ ~ ~))
...
CISP_DEFCLASS((setf token token) (setf other other)) == ((t o k e n, token)) ((o t h e r, other))
]]]
